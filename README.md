...
| Luxembourg communes | **100** |
| Physical cash-access points | **332** |
| ATMs | **139** |
| Bank branches | **148** |
| Post offices | **45** |
| Road-network nodes | **23,529** |
| Road-network edges | **54,544** |
...
![Population-weighted ATM accessibility across Luxembourg](outputs/06_commune_atm_accessibility.png)

*Population-weighted ATM accessibility by Luxembourg commune. This is the primary spatial view of the project and provides an immediate picture of how accessibility varies across Luxembourg.*
...
![Local spatial association of ATM accessibility](outputs/10_atm_accessibility_lisa.png)

*Local Moran's I / LISA classification of commune-level ATM accessibility.*
...
![ATM accessibility map](outputs/02_atm_accessibility_map.png)

*Spatial distribution of straight-line distance to the nearest ATM.*
...
![Highest modeled ATM closure impact](outputs/12_worst_atm_closure_map.png)

*ATM accessibility with the highest-ranked single-ATM closure highlighted. Closure results are scenario-based, not causal forecasts.*
